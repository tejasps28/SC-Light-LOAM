...
int main(int argc, char **argv)
{
    ...
    while (ros::ok())
    {
            ...
            !fullPointsBuf.empty())
        {
            ...
            laserOdometry.header.frame_id = "map"; //"rslidar";
            ...
            laserPath.header.frame_id = "map";//"rslidar";
            ...
            if (frameCount % skipFrameNum == 0)
            {
                ...
                laserCloudCornerLast2.header.frame_id = "map";//"/camera";
                pubLaserCloudCornerLast.publish(laserCloudCornerLast2);

                sensor_msgs::PointCloud2 laserCloudSurfLast2;
                pcl::toROSMsg(*laserCloudSurfLast, laserCloudSurfLast2);
                laserCloudSurfLast2.header.stamp = ros::Time().fromSec(timeSurfPointsLessFlat);
                laserCloudSurfLast2.header.frame_id = "map";//"/camera";
                pubLaserCloudSurfLast.publish(laserCloudSurfLast2);

                sensor_msgs::PointCloud2 laserCloudFullRes3;
                pcl::toROSMsg(*laserCloudFullRes, laserCloudFullRes3);
                laserCloudFullRes3.header.stamp = ros::Time().fromSec(timeSurfPointsLessFlat);
                laserCloudFullRes3.header.frame_id = "map";//"/camera";
