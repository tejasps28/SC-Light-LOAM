...
ros::Publisher pubLaserCloudFullResLocal; //Added by Tejas
...
void laserOdometryHandler(const nav_msgs::Odometry::ConstPtr &laserOdometry)
{
	...
	odomAftMapped.header.frame_id = "map";//"velo_link";
	odomAftMapped.child_frame_id = "base_link";//"/aft_mapped";
	...
	while(1)
	{
			...
			!fullResBuf.empty() && !odometryBuf.empty())
		{
			...
			if (frameCount % 5 == 0)
			{
				...
				laserCloudSurround3.header.frame_id = "map";//"velo_link";
			...
			if (frameCount % 20 == 0)
			{
				...
				laserCloudMsg.header.frame_id = "map";//"velo_link";
			...
			laserCloudFullRes3Local.header.frame_id = "map"; //"camera_init";
			...
			laserCloudFullRes3.header.frame_id = "map"; //"velo_link";
			...
			laserAfterMappedPath.header.frame_id = "map"; //"velo_link";
